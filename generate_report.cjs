...
console.log("Generating Official SRS Document with embedded 11 Diagrams...");
...
function getDiagramImage(filename, width = 550, height = 350) {
  const pngFilename = filename.endsWith('.svg') ? filename.replace('.svg', '.png') : filename;
  const filePath = path.join(diagramsDir, pngFilename);
  if (fs.existsSync(filePath)) {
    ...
    try {
      ...
      console.warn(`Could not embed image ${pngFilename}:`, e.message);
    }
  }
  return new Paragraph({
    alignment: AlignmentType.CENTER,
    children: [new TextRun({ text: `[Tệp sơ đồ: ${filename}]`, italic: true, color: "64748B" })],
  });
}
  ...
  sections: [
    {
      ...
      children: [
        ...
        getDiagramImage("hinh_2_1_use_case_tong_quan.svg", 520, 340),
        ...
        getDiagramImage("hinh_2_2_use_case_quan_tri_vien.svg", 500, 320),
        ...
        getDiagramImage("hinh_2_3_use_case_hanh_khach_ai.svg", 520, 330),
        ...
        getDiagramImage("hinh_2_4_quy_trinh_su_dung_phan_mem.svg", 480, 340),
        ...
        getDiagramImage("hinh_2_5_quy_trinh_quan_ly_chuyen_bay.svg", 480, 310),
        ...
        getDiagramImage("hinh_2_6_quy_trinh_dat_ve_thanh_toan.svg", 480, 340),
        ...
        getDiagramImage("hinh_2_7_quy_trinh_chon_ghe_giu_cho.svg", 480, 310),
        ...
        getDiagramImage("hinh_2_8_quy_trinh_quan_ly_nguoi_dung.svg", 480, 300),
        ...
        getDiagramImage("hinh_2_9_quy_trinh_checkin_truc_tuyen.svg", 480, 310),
        ...
        getDiagramImage("hinh_2_10_quy_trinh_tu_van_ai_skyai.svg", 500, 340),
        ...
        getDiagramImage("hinh_2_11_quy_trinh_doi_huy_ve.svg", 480, 310),
...
const outputPath = path.join(__dirname, "Bao_Cao_SRS_SkyLink_Full_PNG_Diagrams.docx");

Packer.toBuffer(doc).then((buffer) => {
  fs.writeFileSync(outputPath, buffer);
  console.log(`✅ Final SRS Word Document generated: ${outputPath}`);
}).catch((err) => {
